...
Spotted something not on this list? Please [open an issue](https://github.com/PrincNL/kairo-ai/issues/new/choose). An alpha that documents its own limits is much easier to work with than one that hides them.
