...
[Docs](https://princnl.github.io/kairo-ai) · [Roadmap](./ROADMAP.md) · [Architecture](./ARCHITECTURE.md) · [Known issues](./KNOWN_ISSUES.md)
...
If you prefer to download the release artifacts yourself, grab both files from the latest release under <https://github.com/PrincNL/kairo-ai/releases>:
...
```powershell
git clone https://github.com/PrincNL/kairo-ai.git
cd kairo-ai
...
- [Good first issues](https://github.com/PrincNL/kairo-ai/labels/good%20first%20issue) — small, well-scoped tasks
