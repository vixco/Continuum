...
mod tests {
    ...
    const SYSTEM_INIT_JSON: &str = r#"{"type":"system","subtype":"init","cwd":"F:\\TRYORVIA\\continuum-ai","session_id":"f33ddd7b-e6ed-4cdb-b4be-fb166b9a7a3d","tools":["Task","Bash","Edit","Glob","Grep","Read","Write"],"mcp_servers":[],"model":"claude-opus-4-6","permissionMode":"default","apiKeySource":"none","claude_code_version":"2.1.100","uuid":"6b5e8466-80b2-4e34-b671-e39e16c50254","fast_mode_state":"off"}"#;
