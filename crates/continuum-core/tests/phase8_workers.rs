...
use continuum_core::config::WorkersConfig;
use continuum_core::workers::intent::{read_snapshot, write_intent, WorkerIntent};
use continuum_core::workers::{
...
async fn failure_streak_refuses_repeat_task() {
    ...
    use continuum_core::workers::WorkerSnapshot;
    for i in 0..2 {
