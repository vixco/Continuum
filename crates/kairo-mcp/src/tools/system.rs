//! # System info tools (`mcp__kairo__system_*`)
//!
...
pub fn active_window() -> ActiveWindowResponse {
    let (title, process_name) = kairo_core::senses::context::foreground_window();
...
/// Minimum time between consecutive notifications from the same kairo-mcp
