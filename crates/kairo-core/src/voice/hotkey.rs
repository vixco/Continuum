...
//! trigger voice capture without Kairo's window having focus. The registered
...
const KAIRO_HOTKEY_STOP_MSG: u32 = 0x0400 + 42;
    ...
    let thread = std::thread::Builder::new()
        ...
        .spawn(move || {
            ...
            loop {
                ...
                } else if msg.message == KAIRO_HOTKEY_STOP_MSG
