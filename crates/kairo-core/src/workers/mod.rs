...
//! `mcp__kairo__workers_*` MCP tools. The Kairo MCP server writes an intent
//! file under `~/.kairo-dev/worker-intents/`; the running kairo runtime
...
//! - [`intent`] — disk protocol between kairo-mcp and the pool (no heavy deps)
