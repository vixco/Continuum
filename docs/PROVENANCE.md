...
- `git shortlog -sne --all` reports 77 commits as `Princ` and 2 as `T`; both aliases use the same GitHub noreply address, `93612321+vixco@users.noreply.github.com`. No other author email appears in the preserved history.
